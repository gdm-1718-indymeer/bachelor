...
const Fill = ({ navigation, setKey }) => {
    ...
    return (
        <div className="smartbox " data-aos="fade-left" data-aos-offset="500" data-aos-duration="500" data-aos-easing="ease-out-cubic">
            ...
            <div class="alert alert-warning flex align-items-center" role="alert">
            ...
            <div class="alert alert-warning flex align-items-center" role="alert">
                ...
                <div>
                Laat de machine op de originele staat staan en wacht tot verdere instructies
                </div>
            </div>
            <div className='d-flex justify-content-center pb-100'>
