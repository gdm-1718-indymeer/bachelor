...
import { updatePersonalInformation, getUserData, uploadProfilePicture } from '../../../services/auth.services'
                        ...
                        <div className="container ">
                            ...
                            <div className='img-wrapper'>
                                ...
                                <div className="d-inline">
                                    <img className="picture" src={state.photo} /><br />
                                    <input type="file" id="photoURL" name="photoURL" accept="image/png, image/jpeg" onChange={handleChange} hidden />
                                    <label className="btn" htmlFor="photoURL">Profielfoto aanpassen</label>
                                </div>
                            </div>
                            ...
                            <form>
                                <div className="form-group">
                                    ...
                                    <input type="text" className="form-control" id="fullName" value={state.displayName} />
                                </div>

                                <div className="form-group">
                                    <label htmlFor='email'>Email</label>
                                    <input type="email" className="form-control" value={state.email} id="email" />
                                </div>
                                ...
                                <div className="row mt-5">
                                    <div className="col">
                                        <button type="button" className="btn btn-primary btn-block" onClick={onSubmit}>Opslaan</button>
                                    </div>
