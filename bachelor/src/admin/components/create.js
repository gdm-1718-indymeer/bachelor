      ...
      <Form style={{ margin: '50px' }}>
        <Form.Row >
          ...
          <Col className='medicine-form__input'>
            ...
            <ReactQuill value={formdata.description || props.location.state.description || ''} name='description' onChange={(html) => setFormdata({ ...formdata, description: html })} />
          </Col>

          <Col className='medicine-form__input'>
            <Form.Label>Bijsluiters (bv. max 4uur tussen)</Form.Label>
            <ReactQuill value={formdata.warn || props.location.state.warn || ''} name='warn' onChange={(html) => setFormdata({ ...formdata, warn: html })} />
          </Col>
